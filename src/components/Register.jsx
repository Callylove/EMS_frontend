    ...
    <div className="w-full flex flex-col min-h-screen justify-start items-center">
      <div className="flex flex-col border rounded shadow p-2 md:p-6">
        ...
        >
          ...
          />
          {errors.fullname && <span className="text-red-600">{errors.fullname}</span>}
          <label htmlFor="email" className="font-normal tracking-medium">
            Email
          </label>
          <input
            type="email"
          ...
          />
          {errors.email && <span className="text-red-600">{errors.email}</span>}
          <label htmlFor="phone" className="font-normal tracking-medium">
            Phone Number
          </label>
          <input
            type="text"
          ...
          />
          {errors.phone && <span className="text-red-600">{errors.phone}</span>}
          <label htmlFor="password" className="font-normal tracking-medium">
            Password
          </label>
          <input
            type="password"
          ...
          />
          {errors.password && <span className="text-red-600">{errors.password}</span>}
          <label htmlFor="emp_id" className="font-normal tracking-medium">
            Employee ID
          </label>
          <input
            type="text"
            ...
            disabled
          />
          <label htmlFor="nin" className="font-normal tracking-medium">
            NIN number
          </label>
          <input
            type="text"
          ...
          />
          {errors.nin && <span className="text-red-600">{errors.nin}</span>}
          <label htmlFor="salary" className="font-normal tracking-medium">
            Salary
          </label>
          <input
            type="text"
          ...
          />
          {errors.salary && <span className="text-red-600">{errors.salary}</span>}
          <label htmlFor="category_id" className="font-normal tracking-medium">
            Category
          </label>
          <select
            onChange={(e) => {
          ...
          <label htmlFor="image" className="font-normal tracking-medium">
            Image
          </label>
          <input
            type="file"
          ...
          >
            {isLoading ? (
              <div className="w-5 h-5 border-4 border-t-4 border-white rounded-full animate-spin" role="status"></div>
            ) : (
              "Create Account"
            )}
          </button>
